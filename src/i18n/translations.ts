...
export const translations = {
    es: {
        ...
        nav_terms: "Términos",
        footer_statement: "Elevando la infraestructura empresarial a través de ecosistemas de agentes inteligentes y hosting de carbono neutral.",
        contact_cta: "Contáctanos",
        hero_title_1: "Orquestación Agentica",
        hero_title_2: "El Sistema Nervioso Empresarial",
        hero_subtitle: "Conectamos datos, nube e IA bajo una capa de inteligencia que no solo automatiza: <span class='text-white font-medium'>aprende, evoluciona y crece con su negocio.</span> <br />Del software aislado al ecosistema orquestado.",
        ...
        arch_title: "El Futuro no es un Agente.",
        arch_title_1: "Son Ecosistemas.",
        arch_subtitle: "Una plataforma multi-agente capaz de resolver desde tareas sencillas hasta orquestaciones complejas.",
        agents_badge: "DirIA · Agentes",
        agents_title: "Múltiples Expertos.",
        agents_title_1: "Una Inteligencia.",
        ...
        essence_badge: "Nuestra Esencia",
        essence_title: "Sabiduría Ancestral",
        essence_title_1: "Tecnología Futura",
    ...
    en: {
        ...
        nav_privacy: "Privacy",
        nav_terms: "Terms",
        footer_statement: "Elevating enterprise infrastructure through intelligent agent ecosystems and carbon-neutral hosting.",
        contact_cta: "Contact Us",
        hero_title_1: "Agentic Orchestration",
        hero_title_2: "The Enterprise Nervous System",
        hero_subtitle: "We connect data, cloud, and AI under an intelligence layer that doesn't just automate: <span class='text-white font-medium'>it learns, evolves, and grows with your business.</span> <br />From isolated software to an orchestrated ecosystem.",
        ...
        arch_title: "The Future is not an Agent.",
        arch_title_1: "It's Ecosystems.", // Agregado
